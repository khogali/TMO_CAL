    ...
    return (
        <div className="flex h-[100dvh] bg-background text-foreground overflow-hidden">
            ...
            <div className="flex-1 flex flex-col relative w-full overflow-hidden">
                ...
                {/* 
                    Main Content Area.
                    We now enforce internal scrolling for ALL views (via MobileAppShell or direct styling)
                    to ensure consistent layout behavior and avoid clipping issues.
                */}
